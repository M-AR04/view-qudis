...
const translations = {
  en: {
    ...
    menu: {
      ...
      categories: {
        breakfast: "Breakfast",
        coldAppetizers: "Salads & Starters",
        hotAppetizers: "Hot Appetizers",
        grills: "The Grills",
        mains: "Main Pottery & Trays",
        coldDrinks: "Cold Drinks & Juices",
        hotDrinks: "Hot Beverages",
        desserts: "Desserts & Ice Cream",
        shisha: "Shisha Lounge",
        addons: "Healthy & Extras",
      },
    },
    packages: {
  ...
  ar: {
    ...
    menu: {
      ...
      categories: {
        ...
        coldAppetizers: "سلطات ومقبلات باردة",
        hotAppetizers: "المقبلات الساخنة",
        grills: "المشاوي اللذيذة",
        mains: "الفخارات والصواني الرئيسية",
        coldDrinks: "المشروبات الباردة والعصائر",
        hotDrinks: "المشروبات الساخنة",
        desserts: "الحلويات والآيس كريم",
        shisha: "صالة الأراجيل",
        addons: "خيارات صحية وإضافات",
      },
    },
    packages: {
      tag: "تجارب منسقة",
